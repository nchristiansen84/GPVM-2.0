package jjp.gpvm;
/**
* Opcode ADDF adds two fixed point numbers from the top 
...
*	Post: the top two values on the stack will be the sum, possible 
...
* @since   March 2016 
*/
public class ADDF extends AbstractOpCode {
	/**
	 * constructs an add fixed point opcode.
	 */
	public ADDF(){
		super("addf", "Fixed point addition", 0);
	}
        /**
         * Functor to execute the add fixed point.
         */ 
